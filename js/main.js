document.addEventListener('DOMContentLoaded', function() {
    ...
    var wmsLayers = [
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:06 Cobertura vegetal humedales', displayName: '06 Cobertura vegetal humedales' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:05 Sistema hídrico', displayName: '05 Sistema hídrico' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:04 Páramos', displayName: '04 Páramos' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:03 Humedales', displayName: '03 Humedales' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:02 Cuerpos de agua', displayName: '02 Cuerpos de agua' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:Localidades Base Ref', displayName: 'Localidades Base Ref' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:Localidad_2018_03', displayName: 'Localidad_2018_03' },
